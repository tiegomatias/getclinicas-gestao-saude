      ...
      <main>
        <section className="py-10 md:py-20 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-md md:text-xl text-gray-600 mb-6 md:mb-10">
        ...
        <section id="plans-section" className="py-10 md:py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
              ...
              {/* Plano Semestral */}
              <Card className={`shadow-lg hover:shadow-xl transition-shadow border-t-4 border-purple-500 ${!isMobile ? 'scale-105 z-10' : 'my-6'}`}>
        ...
        <section className="py-10 md:py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">Funcionalidades Principais</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Gestão de Pacientes</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Gestão de Leitos</h3>
                <p className="text-gray-600">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg md:text-xl font-bold mb-2">Relatórios Detalhados</h3>
                <p className="text-gray-600">
