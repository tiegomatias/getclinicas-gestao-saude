...
serve(async (req) => {
  ...
  try {
    ...
    // Criar cliente Supabase com o Authorization header (método oficial do Supabase)
    ...
    logStep("Supabase client created with auth context");

    // Obter o usuário autenticado (sem passar token - usa o header do client)
